...
/**
 * Görsel öncelikli kart. İkon yok.
 * Görsel alanı HER ZAMAN 3:2 — yüklenen dosyanın kendi ölçüsü kart yüksekliğini değiştirmez.
 * Görsel esnetilmez: object-cover + object-center ile kırpılır.
 */
