...
export const metadata: Metadata = { title: "Projeler", description: "Web, e-ticaret, network ve güvenlik projelerimizden örnekler.", alternates: { canonical: `${site.url}/projeler` } };
