...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    ...["/hizmetler", "/destek", "/sektorler", "/projeler", "/hakkimizda", "/blog", "/hizmet-bolgeleri", "/iletisim"].map((p) => ({ url: u(p), lastModified: now, priority: 0.8 })),
    ...
    ...destek.map((d) => ({ url: u(`/destek/${d.slug}`), lastModified: now, priority: 0.8 })),
