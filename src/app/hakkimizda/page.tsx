...
export default function Page() {
  return (
    <>
      <PageHeader kicker="Hakkımızda" title="Dijital ve teknik tarafı aynı ekipten alın" lead="Çoğu işletme web sitesi için bir ajansla, kamera için bir teknik servisle, network için başka biriyle uğraşır. Biz bu ikisini aynı çatı altında topladık." crumbs={[{ name: "Hakkımızda" }]} />
