...
export default function Page() {
  return (
    <>
      <PageHeader kicker="Sektörler" title="Kime hizmet veriyoruz?" lead="Bir sitenin ihtiyacı ile bir restoranınki aynı değil. Her müşteri tipi için hangi sorunu çözdüğümüzü ve nereden başladığımızı görün." crumbs={[{ name: "Sektörler" }]} />
